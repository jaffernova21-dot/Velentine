...
const DECORATIONS = [
    ...
    // Bottom Right
    { src: "/duck2.webp", alt: "cute valentines gift", bottom: "2%", right: "0%", scale: 1.25, rotate: "0deg" },
    // Top Left
    // Start after 1s
    { src: "/duck5.webp", alt: "romantic valentine game", top: "15%", left: "5%", scale: 0.9, rotate: "-7deg", hiddenOnMobile: true, waddle: true, delay: "1s" },
    // Top Right
    { src: "/duck4.webp", alt: "14 feb valentine game", top: "15%", right: "5%", scale: 1.1, rotate: "7deg", hiddenOnMobile: true, waddle: true, delay: "0s" },

    { src: "/duck3.webp", alt: "will you be my valentine", bottom: "35%", left: "5%", scale: 1.0, rotate: "12deg" },
    // Start after 2s
    ...
    // Tiny Icons
    { src: "/comment.svg", alt: "valentine", bottom: "18%", left: "15%", scale: 0.5, },
    { src: "/comment.svg", alt: "love", top: "25%", right: "15%", scale: 0.5, hiddenOnMobile: true },
    { src: "/ily.webp", alt: "i love you", top: "28%", left: "12%", scale: 0.2, rotate: "20deg" },
    { src: "/ily.webp", alt: "cute valentine wish", bottom: "15%", right: "20%", scale: 0.2 },
