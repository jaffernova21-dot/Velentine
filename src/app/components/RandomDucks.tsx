...
const DECORATIONS = [
    ...
    // Bottom Right
    { src: "/duck2.webp", alt: "will you be my valentine gifts for her", bottom: "2%", right: "0%", scale: 1.25, rotate: "0deg" },
    // Top Left
    // Start after 1s
    ...
    // Top Right
    { src: "/duck4.webp", alt: "will you be my valentine gifts for her", top: "15%", right: "5%", scale: 1.1, rotate: "7deg", hiddenOnMobile: true, waddle: true, delay: "0s" },

    { src: "/duck3.webp", alt: "will you be my valentine card", bottom: "35%", left: "5%", scale: 1.0, rotate: "12deg" },
    // Start after 2s
    { src: "/duck7.webp", alt: "will you be my valentine", bottom: "34%", right: "4%", scale: 0.85, waddle: true, delay: "2s" },
    // Start after 0.5s
    ...
    { src: "/duck8.webp", alt: "will you be my valentine", bottom: "1%", right: "22%", scale: 0.85, hiddenOnMobile: true },
    // Start after 1.5s
    { src: "/duck9.webp", alt: "will you be my valentine answer", bottom: "1%", left: "25%", scale: 1.0, hiddenOnMobile: true, waddle: true, delay: "1.5s" },

    // Tiny Icons
    { src: "/comment.svg", alt: "will you be my valentine", bottom: "18%", left: "15%", scale: 0.5, },
    { src: "/comment.svg", alt: "will you be my valentine answer", top: "25%", right: "15%", scale: 0.5, hiddenOnMobile: true },
    { src: "/ily.webp", alt: "i love you", top: "28%", left: "12%", scale: 0.2, rotate: "20deg" },
    { src: "/ily.webp", alt: "will you be my valentine wish", bottom: "15%", right: "20%", scale: 0.2 },
    { src: "/ily.webp", alt: "will you be my valentine gift", bottom: "0%", right: "40%", scale: 0.15 },
];
